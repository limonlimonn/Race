...
{
	/// <summary>
	/// Класс - окно, когда удачно доехали до финиша
	/// </summary>

	public class RecordFinishPanel : ABaseFinishRecordRaceWithSmiles, IUIWindow
	{
		// ACTIONS
		...
		// used on button !
		public void OnClickButton_SmileSmall(int id)
		{
